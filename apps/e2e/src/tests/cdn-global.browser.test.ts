/**
 * CDN Global Build Browser Test
 * Tests the cdn/index.global.js global build in isolation
 */
...
describe('CDN Global Build Test (cdn/index.global.js)', () => {
  test('should load CDN Global build and render QTI test structure', async () => {
    // Load the CDN Global build via script tag (since it's not an ES module)
    const script = document.createElement('script');
    script.src = '/cdn/index.global.js';
