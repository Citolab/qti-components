...
import type { QtiGapMatchInteraction, QtiGapText } from '@citolab/qti-components';
...
const meta: Meta<QtiGapMatchInteraction> = {
  ...
  tags: ['autodocs', 'skip-test', 'drag-drop']
};
export default meta;
    ...
    return html`
      ${template(
        ...
        html`<qti-prompt>Identify the missing words in this famous quote from Shakespeare's Richard III.</qti-prompt>
          ...
          <blockquote>
            <p>
              Now is the <qti-gap class="qti-input-width-6" identifier="G1"></qti-gap> of our discontent<br />
              Made glorious <qti-gap class="qti-input-width-6" identifier="G2"></qti-gap> by this sun of York;<br />
