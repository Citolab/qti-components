...
'use strict';
//
define(['qtiCustomInteractionContext', 'jquery'], function (ctx, $) {
  ...
  var self = {
    ...
    render: function () {
      ...
      var interaction = ["<svg width='${gridWidth}px' height='${gridHeight}px' style='float: left'>"];
