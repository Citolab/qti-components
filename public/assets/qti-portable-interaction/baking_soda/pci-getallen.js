(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
        (global['@citolab/pci-getallen'] = factory(global.ctx)));
})(this, function (ctx) {
  'use strict';
  ...
  function m$1(n) {
    ((!n.__d && (n.__d = !0) && t$1.push(n) && !g$1.__r++) || o$2 !== l$1.debounceRendering) &&
      ((o$2 = l$1.debounceRendering) || r$1)(g$1);
  }
  function g$1() {
  ...
  function w$1(n, l, u, i, t, r, o, f, s, a) {
    var h,
      v,
      p,
      _,
    ...
    for (u.__k = [], h = 0; h < l.length; h++)
      if (
        ...
        j$1(n, _, (p = p || e$2), t, r, o, f, s, a),
          (b = _.__e),
          (v = _.ref) && p.ref != v && (g || (g = []), p.ref && g.push(p.ref, null, _), g.push(v, _.__c || b, _)),
          null != b
            ? (null == m && (m = b),
              'function' == typeof _.type && _.__k === p.__k ? (_.__d = s = x$1(_, s, n)) : (s = P(n, _, p, w, b, s)),
              'function' == typeof u.type && (u.__d = s))
            : s && p.__e == s && s.parentNode != n && (s = k$1(p));
      }
    for (u.__e = m, h = A; h--; )
      null != w[h] &&
        ('function' == typeof u.type && null != w[h].__e && w[h].__e == u.__d && (u.__d = k$1(i, h + 1)),
        N(w[h], w[h]));
    if (g) for (h = 0; h < g.length; h++) M(g[h], g[++h], g[++h]);
  }
  function x$1(n, l, u) {
    for (var i, t = n.__k, r = 0; t && r < t.length; r++)
      (i = t[r]) && ((i.__ = n), (l = 'function' == typeof i.type ? x$1(i, l, u) : P(u, i, i, t, i.__e, l)));
    return l;
  }
  ...
  function H(n, l, u, i, t) {
    ...
    n: if ('style' === l)
      ...
      'function' == typeof u ||
        (null != u && (!1 !== u || ('a' === l[0] && 'r' === l[1])) ? n.setAttribute(l, u) : n.removeAttribute(l));
    }
  }
  function I(n) {
  ...
  function j$1(n, u, i, t, r, o, f, e, c) {
    var s,
      h,
      v,
      y,
      ...
      n: if ('function' == typeof P) {
        if (
          ...
          null != P.getDerivedStateFromProps &&
            (h.__s == h.state && (h.__s = a$1({}, h.__s)), a$1(h.__s, P.getDerivedStateFromProps(m, h.__s))),
          (y = h.props),
          (p = h.state),
          v)
        )
          ...
          if (
            ...
            (!h.__e && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(m, h.__s, x)) ||
              u.__v === i.__v)
          ) {
            (h.props = m),
              (h.state = h.__s),
        ...
        (h.context = x),
          ...
          (A = null != s && s.type === d$1 && null == s.key ? s.props.children : s),
          w$1(n, Array.isArray(A) ? A : [A], u, i, t, r, o, f, e, c),
          (h.base = u.__e),
          (u.__h = null),
          h.__h.length && f.push(h),
          b && (h.__E = h.__ = null),
        ...
        null == o && u.__v === i.__v ? ((u.__k = i.__k), (u.__e = i.__e)) : (u.__e = L(i.__e, u, i, t, r, o, f, c));
      (s = l$1.diffed) && s(u);
    } catch (n) {
  ...
  function L(l, u, i, t, r, o, f, c) {
    ...
    if (null === d) y === p || (c && l.data === p) || (l.data = p);
      ...
      if (
        ...
        (a = (y = i.props || e$2).dangerouslySetInnerHTML),
        ...
        (v || a) &&
          ((v && ((a && v.__html == a.__html) || v.__html === l.innerHTML)) || (l.innerHTML = (v && v.__html) || ''));
      }
      if ((C(l, p, y, r, c), v)) u.__k = [];
      else if (
        ((_ = u.props.children),
        w$1(l, Array.isArray(_) ? _ : [_], u, i, t, r && 'foreignObject' !== d, o, f, o ? o[0] : i.__k && k$1(i, 0), c),
        null != o)
      )
  ...
  (n = c$1.slice),
    ...
    (_.prototype.setState = function (n, l) {
      var u;
      (u = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = a$1({}, this.state))),
    ...
    (_.prototype.render = d$1),
    (t$1 = []),
    (r$1 = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
    (g$1.__r = 0);
  ...
  var factorial = function (x) {
    return x >= 0 ? (x < 2 ? 1 : x * factorial(x - 1)) : NaN;
  };
  ...
  var methods = {
    ...
    MEAN: function () {
      ...
      return (
        [].concat(args).reduce(function (sum, x) {
          return sum + x;
  ...
  var isSymbol = function (token) {
    return Object.keys(symbols).includes(token);
  };
  ...
  var isMethod = function (token) {
    return Object.keys(methods).includes(token);
  };
  ...
  var isOpenParenthesis = function (token) {
    return /\(/.test(token);
  };

  var isCloseParenthesis = function (token) {
    return /\)/.test(token);
  };
  ...
  function topOperatorHasPrecedence(operatorStack, currentOperatorName) {
    ...
    if (topOperator.precedence > currentOperator.precedence) {
      return true;
    }
  ...
  function parse(expression) {
    ...
    var infixExpression = (expression.match(pattern) || [])
        ...
        { className: 'flex space-x-4' },
        {
          children: [
            e$1(
              'div',
              Object.assign(
                { className: 'basis-1/4 flex flex-col space-y-3 p-3' },
                {
                  children: [
                    e$1(
                      'div',
                          ...
                          children: [
                            e$1(
                              ...
                              Object.assign(
                                {
                                  className:
                                    'flex items-center space-x-2 bg-white shadow border border-gray-200 rounded px-2'
                                },
                                {
                                  children: [
                                    e$1(Apple, { className: 'min-w-[2rem] max-w-[2rem]' }, void 0),
                                    e$1('div', { children: '=' }, void 0),
                                    e$1(
                                      'input',
                                      {
                                        ref: inputReference,
                                        maxLength: 3,
                                        className:
                                          'text-gray-700 text-4xl w-16 leading-tight focus:outline-none focus:shadow-outline'
                                      },
                                      void 0
                                    )
                                  ]
                            ...
                            e$1(Button, Object.assign({ onClick: calc }, { children: buttonText }), void 0)
                          ]
                        }
                      ),
                      void 0
                    ...
                    [sum1, sum2].map(sum => {
                      ...
                      return e$1(
                        'div',
                        Object.assign(
                          { className: 'flex h-16 space-x-1 items-center justify-end text-4xl' },
                          {
                            children: [
                              expression === null || expression === void 0
                                ? void 0
                                : expression.split('').map((sumPart, i) => {
                                    if (sumPart === '#') {
                                      ...
                                      return e$1(
                                        ...
                                        Object.assign(
                                          {
                                            className: 'x*+/'.includes(sumPart.toLowerCase())
                                              ? 'text-gray-400'
                                              : 'italic'
                                          },
                                          { children: sumPart.replace('*', '×') }
                                        ),
                                        i
                                      );
                                    }
                                  }),
                              e$1('div', Object.assign({ className: 'text-gray-400' }, { children: '=' }), void 0)
                            ]
                          }
                        ),
                        void 0
            ...
            e$1(
              'div',
              Object.assign(
                { className: 'basis-3/4 bg-gray-100 p-3 rounded overflow-x-auto' },
                {
                  children: e$1(
                    'div',
                    Object.assign(
                      { className: 'flex space-x-2 text-4xl h-full' },
                      {
                        children:
                          state.attempts &&
                          new Array(
                                ...
                                Object.assign(
                                  { className: 'flex flex-col space-y-3' },
                                  {
                                    children: [
                                      e$1(
                                        Block,
                                        Object.assign({ className: 'font-bold' }, { children: attempt }),
                                        void 0
                                      ),
  ...
  function Block(props) {
    ...
    return e$1(
      ...
      Object.assign(
        {},
        props,
        { className: `${props.className} flex items-center justify-center bg-white border-1 text-right h-16 w-16` },
  ...
  function Button(props) {
    return e$1(
      ...
      Object.assign(
        {},
        props,
        { className: 'm-2 bg-blue-500 w-full text-blue-100 whitespace-nowrap py-1 px-6 rounded border-0' },
        { children: props.children }
      ),
      void 0
    );
