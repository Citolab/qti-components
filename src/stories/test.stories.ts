...
import { ItemExtContext, TestContext } from '../lib/qti-test/context/test.context';
    ...
    return html`
      <qti-test
        ...
        @qti-assessment-test-connected=${e => {
          ...
          assessmentTest.context = testContext ? testContext : null;
        }}
      ...
      >
        ...
        >
          ...
          <div class="relative flex flex-1 items-center justify-center gap-2">
            <test-paging-tmpl-button class=" hidden md:flex md:gap-1" info-category="">
              <template>
                <button
