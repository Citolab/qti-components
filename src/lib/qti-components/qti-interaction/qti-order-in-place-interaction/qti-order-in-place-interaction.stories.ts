...
import './qti-order-in-place-interaction';

const meta: Meta = {
  title: '3.2 interaction types/20 Order In Place Interaction',
...
export const Default: Story = {
  ...
  render: args => html`
    <qti-order-interaction-in-place response-identifier="RESPONSE" orientation="${args.orientation}">
      <div slot="prompt">
        <p>Arrange the following historical events in chronological order (earliest first):</p>
      </div>
...
export const Horizontal: Story = {
  ...
  render: args => html`
    <qti-order-interaction-in-place response-identifier="RESPONSE" orientation="${args.orientation}">
      <div slot="prompt">
        <p>Arrange the planets in order from the Sun:</p>
      </div>
