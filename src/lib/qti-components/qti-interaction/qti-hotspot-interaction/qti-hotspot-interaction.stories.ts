...
export const Circle = {
  render: () =>
    html`<qti-hotspot-interaction max-choices="0" response-identifier="RESPONSE1">
...
export const Rect = {
  render: () =>
    html`
      <qti-hotspot-interaction response-identifier="RESPONSE3" max-choices="0" min-choices="0">
        <qti-prompt>
...
export const Poly = {
  render: () =>
    html`<qti-hotspot-interaction response-identifier="RESPONSE" min-choices="1" max-choices="16">
