...
import { watch } from '../../../src/lib/decorators/index.ts';
import { itemContext } from '../../../src/lib/exports/qti-assessment-item.context.ts';
import { itemContextVariables } from '../../../src/lib/exports/item.context.ts';
...
import type { ResponseInteraction } from '../../../src/lib/exports/expression-result.ts';
import type { VariableDeclaration, VariableValue } from '../../../src/lib/exports/variables.ts';
import type { OutcomeVariable, ResponseVariable } from '../../../src/lib/exports/variables.ts';
import type { QtiFeedback } from '../qti-feedback/qti-feedback.ts';
import type { QtiResponseProcessing } from '../qti-response-processing/index.ts';
...
import type { Interaction } from '../../../src/lib/exports/interaction.ts';
