...
export const CircleSelectionsLight: Story = {
  render: () =>
    template(
      {
        ...args,
...
export const CircleSelectionsDark: Story = {
  render: () =>
    template(
      {
        ...args,
...
export const CircleUnselectedHidden: Story = {
  render: () =>
    template(
      {
        ...args,
...
export const Poly: Story = {
  render: () => html`
    <qti-hotspot-interaction max-choices="0">
...
export const PolyResponsive: Story = {
  render: () => html`
    <qti-hotspot-interaction max-choices="0">
      <img src="assets//qti-hotspot-interaction/VH5BG1e_v2.png" />
      ${polyChoices}
    </qti-hotspot-interaction>
  `
};
