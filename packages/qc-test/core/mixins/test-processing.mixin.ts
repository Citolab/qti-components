import type { QtiOutcomeProcessing } from '../../../qc-elements/qti-outcome-processing/qti-outcome-processing';
import type { OutcomeVariable, VariableDeclaration } from '../../../../src/lib/exports/variables';
